    ...
    <div className="flex min-h-screen flex-col flex-1 items-center justify-center bg-transparent font-sans text-[var(--foreground)]">
      <main className="flex flex-1 w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-transparent sm:items-start">
        ...
        <div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
          ...
          <a href="/users" className="font-medium text-[var(--foreground)]">
            Go to Users
          </a>
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          ...
          <a
            className="flex h-12 w-full items-center justify-center rounded-full border border-solid border-black/[.08] transition-colors hover:border-transparent hover:bg-black/[.04] dark:border-dark/[.145] dark:hover:bg-[#1a1a1a] md:w-[158px]"
